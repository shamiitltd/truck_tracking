...
import 'package:truck_tracking/widgets/dashboard/vehicle_maintenence/Usermodel2.dart';
...
class _VehicleMaintanceState extends State<VehicleMaintance> {
  ...
  readLocalJson() async {
    isloading = true;
    var d = await rootBundle.loadString("assets/vehicle_maintenence/vehicle_maintenence_data.json");
