...
class BestDriverApi extends StatefulWidget {
  const BestDriverApi({Key? key}) : super(key: key);

  @override
  _BestDriverApiState createState() => _BestDriverApiState();
}

class _BestDriverApiState extends State<BestDriverApi> {

  var data ;
  Future<void> getUserApi ()async{
    final response = await http.get(Uri.parse('https://raw.githubusercontent.com/Arnabiem/Truck_tracking-_system_json_files/main/best_drivers.json'));
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            v5:data[index]['cancellation_rate'].toString()),                           
                          ],
                        ),
                      ),
                    );
