...
class DriverStatApi extends StatefulWidget {
  const DriverStatApi({Key? key}) : super(key: key);

  @override
  _DriverStatApiState createState() => _DriverStatApiState();
}

class _DriverStatApiState extends State<DriverStatApi> {

  var data ;
  Future<void> getUserApi ()async{
    final response = await http.get(Uri.parse('https://raw.githubusercontent.com/Arnabiem/Truck_tracking-_system_json_files/main/driver_statistics.json'));
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            v5:data[index]['total_earnings'].toString()),                           
                          ],
                        ),
                      ),
                    );
